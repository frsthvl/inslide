<template>
    ...
    >
        <Head>
            <title>Magical Markdown Presentations | Insli.de</title>
            <meta
                name="description"
                content="Create automatically styled presentations from your markdown files in seconds. Completely free, no registration required."
            />

            <meta
                property="og:title"
                content="Magical Markdown Presentations | Insli.de"
            />
            <meta
            ...
            <meta
                property="og:image"
                content="https://insli.de/og-image.jpeg"
            />
            <meta property="og:url" content="https://insli.de" />
        </Head>
...
export default {
    ...
    watch: {
        slide() {
            ...
            setTimeout(() => {
                if (this.$el.querySelector(".confetti")) {
                    this.fire();
                }
            }, 500);
        },
    ...
    methods: {
        ...
        parseFrontMatter() {
            ...
            fetch(this.$config.public.appUrl + "/welcome.md")
                ...
                .then((rawContent) => {
                    ...
                    this.markdownSections = parsed.body
                        .split(/\n\s*\n/)
                        .map((section) => {
                            if (section.includes("[confetti]")) {
                                section = section.replace(
                                    "[confetti]",
                                    '<span class="confetti" style="display: none;"></span>',
                                );
                            }
